...
namespace Nop.Plugin.Payments.CyberSource
{
    ...
    public class CyberSourceDefaults
    {
        ...
        /// </summary>
        public const string PAYMENT_INFO_VIEW_COMPONENT_NAME = "CyberSourcePaymentInfo";

        /// <summary>
        /// Gets a name of the view component to add payer authentication forms
        /// </summary>
        public const string PAYER_AUTHENTICATION_VIEW_COMPONENT_NAME = "CyberSourcePayerAuthentication";
